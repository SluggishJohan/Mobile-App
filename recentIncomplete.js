        ...
        return (
            <View style={style.pageContainer}>
                ...
                <View style={style.headerContainer}>
                    ...
                    <Text style={style.navigation_Heading}>Recent Incomplete</Text>

                </View>

                <View style={style.contentContainer_has_header}>
                    <ScrollView>
                        <Text style={style.instructions}>Here presents the latest 25 incomplete records in today: (DoB
                            MM/DD/YY)</Text>
                ...
                <Button  onPress={this.save} style={styles.save}>
